...
{
    [Serializable]
    internal class CalCoupledTempDispStep : CalculixKeyword
    {
        // Variables                                                                                                                
        private CoupledTempDispStep _step;
        ...
        // Constructor                                                                                                              
        public CalCoupledTempDispStep(CoupledTempDispStep step)
        {
            _step = step;
        }
        ...
        public override string GetKeywordString()
        {
            ...
            //
            return string.Format("*Coupled temperature-displacement{0}{1}{2}{3}{4}", solver, direct, steadyState, deltmx,
                                 Environment.NewLine);
        }
