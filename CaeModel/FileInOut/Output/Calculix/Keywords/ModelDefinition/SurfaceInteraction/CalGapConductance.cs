...
namespace FileInOut.Output.Calculix
{
    ...
    internal class CalGapConductance : CalculixKeyword
    {
        ...
        public override string GetDataString()
        {
            ...
            {
                sb.AppendFormat("{0}{1}", _gapConductance.ConductnancePressureTemp[0][0], Environment.NewLine);
            }
            else if (_gapConductance.GapConductanceType == GapConductanceEnum.Tabular)
            {
                ...
                {
                    sb.AppendFormat("{0}, {1}, {2}{3}", _gapConductance.ConductnancePressureTemp[i][0],
