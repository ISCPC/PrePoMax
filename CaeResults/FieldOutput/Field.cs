...
namespace CaeResults
{
    ...
    public class Field : NamedClass
    {
        ...
        {
            bool isComplex = FOFieldNames.IsCompex(_name);
        ...
        public void ComputeInvariants(bool setToNaN)
        {
            ...
            switch (_name)
            {
                ...
                case FOFieldNames.Norm:
                    ComputeVectorFieldInvariant(setToNaN);
                    break;
                case FOFieldNames.DispI:
                case FOFieldNames.ForcI:
                    ComputeVectorFieldInvariant(true);  // always set to NaN
                    break;
