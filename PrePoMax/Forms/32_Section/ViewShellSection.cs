...
namespace PrePoMax
{
    ...
    {
        // Variables                                                                                                                
        private CaeModel.ShellSection _shellSection;
        ...
        [DescriptionAttribute("Set the offset of the shell mid-surface in regard to the selected geometry. The unit is the shell thickness.")]
