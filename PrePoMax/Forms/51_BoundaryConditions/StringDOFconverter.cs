...
namespace PrePoMax
{
    ...
    public class StringConstrainedDOFConverter : System.ComponentModel.TypeConverter
    {
        private ArrayList values;
        private string _fixed = "Fixed";
        public StringConstrainedDOFConverter()
        {
            // Initializes the standard values list with defaults.
        ...
        public override object ConvertFrom(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            ...
            {
                double newVal;
                if (String.Equals(value, _fixed)) newVal = double.PositiveInfinity;
                else newVal = double.Parse((string)value);
                return newVal;
            }
            else return base.ConvertFrom(context, culture, value);
