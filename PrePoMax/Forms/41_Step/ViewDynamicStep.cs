...
namespace PrePoMax
{
    ...
    public class ViewDynamicStep : ViewStaticStep
    {
        ...
        //
        [CategoryAttribute("Data")]
        [OrderedDisplayName(4, 10, "Solution procedure")]
        ...
        //
        [CategoryAttribute("Data")]
        [OrderedDisplayName(5, 10, "Relative to absolute")]
        ...
        // Constructors                                                                                                             
        public ViewDynamicStep(DynamicStep step)
            : base(step, false)
        {
            _dynamicStep = step;
            InstallProvider();
            ...
            //
            _dctd.GetProperty(nameof(Nlgeom)).SetIsBrowsable(false);    // dynamic step is always nonlinear
        }
