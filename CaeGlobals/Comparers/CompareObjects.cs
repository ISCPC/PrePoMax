...
namespace CaeGlobals
{
    ...
    {
        public static bool IsEqual<T>(T expectInput, T actualInput)
        {
            ...
            if (expectInput is IEnumerable)
            {
                ...
                while (canGetExpectMember && canGetActualMember && true)
                {
                    ...
                    object isEqual = typeof(CompareObjects).GetMethod("IsEqual").MakeGenericMethod(currentType).Invoke(null, new object[] { expectEnumerator.Current, actualEnumerator.Current });
            ...
            foreach (var property in properties)
            {
                ...
                object isEqual = typeof(CompareObjects).GetMethod("IsEqual").MakeGenericMethod(property.PropertyType).Invoke(null, new object[] { expectValue, actualValue });
